...
import { createDesignation } from "../api/registryServices";
...
const DesignationAddPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log("Creating designation with payload:", {
      ...
      const apiError =
        err?.response?.data?.designation_name?.[0] ||
