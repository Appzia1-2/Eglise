// src/pages/LegacyDeathViewPage.jsx
...
import {
  ...
  LuFlower, LuInfo, LuMapPin, LuPencil, LuPrinter, LuUser, LuUsers,
} from "react-icons/lu";
        ...
        <Center flex="1">
          <Box textAlign="center">
            ...
            <Button h="40px" px="18px" bg="white" color={RED}
                    ...
                    _hover={{ bg: "#FFF8F8" }}>
              <LuArrowLeft size={17} />
              <Text ml="6px">Back to Legacy Death Register</Text>
            </Button>
          </Box>
        </Center>
        <Footer />
          ...
          <Flex justify="space-between" align={{ base: "flex-start", md: "center" }}
            ...
            <Box>
              <Heading color={NAVY}
                ...
                Legacy Death Details
              </Heading>
              <Text color="#667085" fontSize="11px" mt="5px">
                Back-filled historical death record.
              </Text>
            </Box>
            <HStack gap="10px" flexWrap="wrap">
              ...
              <Button h="40px" px="18px" bg={RED} color="white"
                      borderRadius="5px" fontSize="11px" fontWeight="500"
                      onClick={() => navigate(`/legacy/death/${id}/edit`)}
                      _hover={{ bg: RED_DARK }}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "380px 1fr" }}
            ...
            <Box bg="white" border="1px solid" borderColor={BORDER}
              ...
              <VStack gap="7px" align="flex-start">
                <Heading color={NAVY} fontSize="26px" lineHeight="1.15"
                         fontWeight="700" textAlign="left">
                  {displayValue(record.name)}
                </Heading>
                <Flex align="center" gap="8px" color="#62708B"
                      fontSize="13px" flexWrap="wrap">
                  <Text>{displayValue(record.gender)}</Text>
                  <Text>·</Text>
                  <Text>{record.age_at_death ? `${record.age_at_death} yrs` : "—"}</Text>
                </Flex>
              ...
              <VStack align="stretch" gap="13px">
                <InfoRow icon={<LuCalendarDays size={22} />}
                         label="Died On"
                         value={formatDate(record.died_on)}
                         width="92px" />
                <InfoRow icon={<LuCalendarDays size={22} />}
                         label="Funeral On"
                         value={formatDate(record.funeral_on)}
                         width="92px" />
                <InfoRow icon={<LuUsers size={22} />}
                         label="Family"
                         value={record.family_name}
                         width="92px" />
                <InfoRow icon={<LuUser size={22} />}
                         label="House"
                         value={record.house_name}
                         width="92px" />
                <InfoRow icon={<LuChurch size={22} />}
                         label="Priest"
                         value={record.priest_name}
                         width="92px" />
              </VStack>
            </Box>
            ...
            <VStack align="stretch" gap="8px">
              ...
              <SectionCard title="Death & Funeral"
                           icon={<LuFlower size={21} />}>
                <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap="0">
                  <Box pr={{ md: "22px" }} borderRight={{ md: "1px solid #E0E6EF" }}>
                    <VStack align="stretch" gap="7px">
                      <InfoRow label="Old Register No."
                               value={record.reg_no} width="92px" />
                      <InfoRow label="Date of Death"
                               value={formatDate(record.died_on)}
                               width="92px" isRequired />
                      <InfoRow label="Funeral Date"
                               value={formatDate(record.funeral_on)}
                               width="92px" />
                      <InfoRow label="Place of Death"
                  ...
                  <Box pl={{ md: "22px" }} mt={{ base: "10px", md: "0" }}>
                    <VStack align="stretch" gap="7px">
                      <InfoRow label="Reason of Death"
                               value={record.reason_of_death}
                               width="92px" />
                  ...
                  <Box pr={{ md: "22px" }} borderRight={{ md: "1px solid #E0E6EF" }}>
                    <VStack align="stretch" gap="7px">
                      ...
                      <InfoRow label="Date of Birth"
                               ...
                               width="92px" />
                      <InfoRow label="Age at Death"
                               value={record.age_at_death}
                               width="92px" />
              ...
              <SectionCard title="Tomb Details"
                           icon={<LuMapPin size={21} />}>
                <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap="0">
                  <Box pr={{ md: "22px" }} borderRight={{ md: "1px solid #E0E6EF" }}>
                    <VStack align="stretch" gap="7px">
                      <InfoRow label="Tomb Type"
                               value={record.tomb_type_name}
                               width="92px" />
                      <InfoRow label="Tomb Identifier"
                               value={record.tomb_idn}
                               width="92px" />
                    </VStack>
                  </Box>
                  <Box pl={{ md: "22px" }} mt={{ base: "10px", md: "0" }}>
                    <InfoRow label="Tomb Charge"
                             value={record.tomb_charge}
                             width="92px" />
                  </Box>
                </Grid>
              </SectionCard>
...
export default LegacyDeathViewPage;