...
const RelationshipEditPage = () => {
  ...
  const fetchRelationship = async () => {
    try {
      ...
      setOriginalName(relationshipName);

    } catch (err) {
      console.error(
        "Error fetching relationship:",
        err
      );
  ...
  const handleArchive = async () => {
    const confirmed = window.confirm(
      "Are you sure you want to archive this relationship?"
    );
    ...
    try {
      ...
      console.error(
        "Error archiving relationship:",
        err
      );

      const apiError =
        err?.response?.data?.detail ||
        "Unable to archive relationship.";
                  ...
                  <Box>
                    ...
                    >
                      {hasChanges
                        ...
                        : "Make changes to the relationship information."}
                    </Text>
...
export default RelationshipEditPage;