// src/pages/DesignationEditPage.jsx
...
const DesignationEditPage = () => {
  ...
  const fetchDesignation = async () => {
    try {
      ...
      const designationName =
        found.designation_name || "";

      setName(designationName);
      setOriginalName(designationName);
    } catch (err) {
      console.error(
  ...
  const handleArchive = async () => {
    const confirmed = window.confirm(
      "Are you sure you want to archive this designation?"
    );
    ...
    try {
      ...
      console.error(
        "Error archiving designation:",
        err
      );

      const apiError =
        err?.response?.data?.detail ||
        "Unable to archive designation.";
  ...
  const designationCode = `DS-${String(
    designation?.id || "0001"
  ).padStart(4, "0")}`;
                  ...
                  <Box>
                    ...
                    >
                      {hasChanges
                        ...
                        : "Make changes to the designation information."}
                    </Text>
                  </Box>
                </HStack>
              </Box>
