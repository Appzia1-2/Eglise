        ...
        <Box className="print-only" display="none">
          ...
          >
            <thead>
              <tr style={{ borderBottom: "2px solid black" }}>
                ...
                <th style={{ textAlign: "left", padding: "8px 6px", fontSize: "16px", fontWeight: "bold" }}>Age</th>
            ...
            <tbody>
              {members.map((m, index) => (
                ...
                >
                  ...
                  <td style={{ padding: "8px 6px", fontSize: "14px" }}>{m.age ?? "—"}</td>
                  <td style={{ padding: "8px 6px", fontSize: "14px" }}>{m.family_name || "—"}</td>
                  <td style={{ padding: "8px 6px", fontSize: "14px" }}>
                    {m.mobile_no || m.phone_no || "—"}
                  </td>
                </tr>
              ))}
          ...
          <Box mt={4} pt={2} borderTop="1px solid #ddd" textAlign="center">
            ...
            <Text fontSize="9px" color="gray.400" mt={1}>
              Printed from {churchName || "Church"} Age Wise List
            </Text>
          </Box>
        </Box>
      </Container>
