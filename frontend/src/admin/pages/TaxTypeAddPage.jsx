// src/admin/pages/TaxTypeAddPage.jsx
...
const TaxTypeAddPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await adminApi.createTaxType(data);

      toaster.create({
        title: "Success",
        description: `Tax type "${data.tax_type_name}" created successfully.`,
        type: "success",
        duration: 3000,
      });
      ...
      let errorMsg = "Failed to create tax type.";
      ...
      <Container maxW="container.xl" py={4}>
        ...
        <VStack align="start" spacing={1} mb={4}>
          ...
          <Text color="gray.500" fontSize="sm">
            Define a new tax type for billing and invoicing.
          </Text>
        </VStack>
            ...
            <VStack spacing={4} align="stretch">
              ...
              <Flex gap={4} align="center" flexWrap="wrap" pt={2}>
                ...
                <Button
                  ...
                  flexShrink={0}
                >
                  <Icon as={LuSave} boxSize={4} /> Create Tax Type
                </Button>
              </Flex>
            </VStack>
          </form>
